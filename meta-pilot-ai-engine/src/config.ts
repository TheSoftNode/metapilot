...
export const DEVELOPMENT_CONFIG: Partial<AIEngineConfig> = {
  environment: 'development',
  logLevel: 'debug',
  caching: {
    enabled: false,
...
export const PRODUCTION_CONFIG: Partial<AIEngineConfig> = {
...
export const TEST_CONFIG: Partial<AIEngineConfig> = {
  environment: 'development',
