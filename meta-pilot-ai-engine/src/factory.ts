 ...
 */
export async function createBasicEngine(options: EngineOptions = {}): Promise<AIEngine> {
 ...
 */
export async function createEnhancedEngine(options: EngineOptions): Promise<AIEngine> {
 ...
 */
export async function createAIEngine(config: AIEngineConfig, plugins?: Array<{ name: string; plugin: any }>): Promise<AIEngine> {
  const engine = new AIEngine(config);
 ...
 */
export async function createLightweightEngine(): Promise<AIEngine> {
  const config: AIEngineConfig = {
    ...DEFAULT_CONFIG,
 ...
 */
export async function createProductionEngine(options: EngineOptions): Promise<AIEngine> {
  const config: AIEngineConfig = {
    ...DEFAULT_CONFIG,
 ...
 */
export async function createTestEngine(): Promise<AIEngine> {
  const config: AIEngineConfig = {
    ...DEFAULT_CONFIG,
    environment: 'development',
    logLevel: 'debug',
