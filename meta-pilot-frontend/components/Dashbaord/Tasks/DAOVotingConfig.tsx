...
export const DAOVotingConfig: React.FC<DAOVotingConfigProps> = ({ onNext, onBack }) => {
    // Enhanced DAO data with multi-chain support
    const ethereumDAOs = [
        { id: "nouns", name: "Nouns DAO", icon: "/icons/nouns.svg", proposals: 12, chain: "ethereum" },
        { id: "ens", name: "ENS DAO", icon: "/icons/ens.svg", proposals: 8, chain: "ethereum" },
        { id: "compound", name: "Compound", icon: "/icons/compound.svg", proposals: 5, chain: "ethereum" },
        { id: "aave", name: "Aave", icon: "/icons/aave.svg", proposals: 3, chain: "ethereum" },
        { id: "uniswap", name: "Uniswap", icon: "/icons/uniswap.svg", proposals: 7, chain: "ethereum" },
    ];

    // NEW: Solana DAOs for hackathon requirement
    const solanaDAOs = [
        { 
            id: "marinade", 
    ...
    // Combined DAO list
    const popularDAOs = [...ethereumDAOs, ...solanaDAOs];
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h4 className="font-medium text-slate-900 dark:text-slate-100 truncate">{dao.name}</h4>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        {dao.proposals} active proposals
                                    </p>
                                    {(dao as any).description && (
                    ...
                    <div className="col-span-2 md:col-span-3 mt-2">
                        <div className="relative">
                            <Input
                                placeholder="Enter custom DAO address (0x... for Ethereum or base58 for Solana)"
                                value={customDAO}
                                onChange={(e) => {
                        ...
                        {customDAO && (
                            <div className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                ...
                                Auto-detecting network: {customDAO.startsWith('0x') ? 'Ethereum' : 'Solana'}
                            </div>
                        )}
                    </div>
                </div>
